...
| Bad ConfigMap | `./scripts/chaos/break-config.sh student-portal` | New pods fail probes | Unavailable replicas, restarts, probe events | `./scripts/chaos/break-config.sh student-portal --undo` |
